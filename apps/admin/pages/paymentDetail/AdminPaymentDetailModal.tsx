...
import StatusBadge, { Status } from '../../../../packages/common/StatusBagde';
import ArrowIcon from '../../../../packages/../src/Icon/ArrowIcon';
import api from '../../../../packages/hooks/api';
import Button from '../../../../packages/common/Button';
import { PaymentDatailModalProps } from '../../../../packages/types/paymentDetails';
import { TaxDetailResponse } from '../../../../packages/types/taxDetails';
